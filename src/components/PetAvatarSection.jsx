...
function PetAvatarSection({ form, setValue }) {
  ...
  return (
    <section className="rounded-card border border-paw-border bg-white p-5">
      <div className="mb-4 text-sm font-semibold text-paw-primary">宠物头像</div>
      <div className="flex items-center gap-4">
        <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-card border border-paw-border bg-paw-background text-4xl">
          {previewUrl ? (
